...
env = environ.Env(
    ...
    CX_GOOGLE_OAUTH2_CREDENTIALS=(str, ""),
    POSTGRESQL_OPS_NAME=(str, ""),
    POSTGRESQL_OPS_USER=(str, ""),
    POSTGRESQL_OPS_PASSWORD=(str, ""),
    POSTGRESQL_OPS_HOST=(str, ""),
    POSTGRESQL_OPS_PORT=(int, 5432),
    POSTGRESQL_PLATFORM_OPS_NAME=(str, ""),
    POSTGRESQL_PLATFORM_OPS_USER=(str, ""),
    POSTGRESQL_PLATFORM_OPS_PASSWORD=(str, ""),
    POSTGRESQL_PLATFORM_OPS_HOST=(str, ""),
    POSTGRESQL_PLATFORM_OPS_PORT=(int, 5432),
)
...
if DEBUG:
    ALLOWED_HOSTS = ["*"]
    # Allow insecure OAuth2 transport for development
...
DATABASES = {
    ...
    "julodb": {
        ...
        "OPTIONS": {
            "options": "-c search_path=ops,public,sb,hst",
            "application_name": "cx-service-julodb",
        },
        "NAME": env("POSTGRESQL_OPS_NAME"),
        "USER": env("POSTGRESQL_OPS_USER"),
        "PASSWORD": env("POSTGRESQL_OPS_PASSWORD"),
        "HOST": env("POSTGRESQL_OPS_HOST"),
        "PORT": env("POSTGRESQL_OPS_PORT"),
    },
    "platformdb": {
        "ENGINE": "django.db.backends.postgresql",
        "OPTIONS": {
            "options": "-c search_path=ops,public,sb,hst",
            "application_name": "cx-service-platformdb",
        },
        "NAME": env("POSTGRESQL_PLATFORM_OPS_NAME"),
        "USER": env("POSTGRESQL_PLATFORM_OPS_USER"),
        "PASSWORD": env("POSTGRESQL_PLATFORM_OPS_PASSWORD"),
        "HOST": env("POSTGRESQL_PLATFORM_OPS_HOST"),
        "PORT": env("POSTGRESQL_PLATFORM_OPS_PORT"),
    },
}
...
STATICFILES_DIRS = [
    BASE_DIR / "static",
]  # Use this if want to debug locally
...
# Always include drf_spectacular for API documentation
...
# Spectacular settings - moved outside DEBUG block for production access
SPECTACULAR_SETTINGS = {
    "TITLE": "CX Service API",
    "DESCRIPTION": "Customer Experience service APIs",
    "VERSION": "1.0.0",
    ...
    "TAGS": [
        ...
        {"name": "OAuth2", "description": "Google OAuth2 authentication"},
        {"name": "Gmail", "description": "Gmail integration and webhooks"},
    ],
}
...
CX_GOOGLE_OAUTH2_CREDENTIALS = env("CX_GOOGLE_OAUTH2_CREDENTIALS")
CX_GOOGLE_CREDENTIALS_FILE = env("CX_GOOGLE_CREDENTIALS_FILE")
